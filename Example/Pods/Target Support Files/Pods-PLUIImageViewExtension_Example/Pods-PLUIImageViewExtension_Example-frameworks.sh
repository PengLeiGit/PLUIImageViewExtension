...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/PLImageResizeMode/PLImageResizeMode.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/PLUIImageViewExtension/PLUIImageViewExtension.framework"
